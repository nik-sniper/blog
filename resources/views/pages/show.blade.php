                ...
                <div class="col-md-8">
                    <article class="post">
                        <div class="post-thumb">
                            <a href="{{route("post.show", $post->slug)}}"><img src="{{$post->getImages()}}" alt=""></a>
                        </div>
                        <div class="post-content">
							...
							<span
                                    class="social-share-title pull-left text-capitalize">{{$post->author->name}} {{$post->getDate()}}</span>
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{$post->author->getImage()}}" class="pull-left img-circle" alt="" width="100" >
                        <h4>{{$post->author->name}}</h4>

                        <p>{{$post->author->status_profile}}</p>
                    </div><!--top comment end-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="single-blog-box">
                                <a href="{{route("post.show", $post->getPrevious()->slug)}}">
                                    <img src="{{$post->getPrevious()->getImages()}}" alt="">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="single-blog-box">
                                <a href="{{route("post.show", $post->getNext()->slug)}}">
                                    <img src="{{$post->getNext()->getImages()}}" alt="">
